...
class Alpha(ruiko.Lexer):
    @staticmethod
    def constants(): return ['a', 'b', 'c']
    @staticmethod
    def cast(): return True
...
class Z(ruiko.Parser):
    @staticmethod
    def bnf():
      return ruiko.And([ruiko.Seq(ruiko.N('Alpha'), 1, -1),ruiko.Bind('n1', ruiko.N('Num')),ruiko.Bind('n2', ruiko.N('Num'))])
    @staticmethod
