...
from rbnf.std.common import (Tokenizer, recover_codes)
...
class url(ruiko.Parser):
    @staticmethod
    def bnf():
      return ruiko.And([ruiko.Bind('prefix', ruiko.Or([ruiko.C('https'),ruiko.C('http')])),ruiko.Bind('slash', ruiko.C('://')),ruiko.Bind('head', ruiko.Named('pattern')),ruiko.Bind('tail', ruiko.Seq(ruiko.And([ruiko.C('/'),ruiko.Named('pattern')]), 0, -1)),ruiko.Seq(ruiko.C('/'), 0, 1)])
    @staticmethod
